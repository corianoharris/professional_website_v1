...
export function ProvenResultsSection() {
  ...
  return (
    <section id="proven-results" className="w-full px-4 md:w-full md:px-16 py-12 md:py-16 border-b relative" aria-labelledby="proven-results-heading">
      {/* Top wave pattern */}
      <svg
      ...
      >
        <defs>
          <linearGradient id="provenResultsGradientTop" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <path d="M0,40 Q300,10 600,40 T1200,40 L1200,0 L0,0 Z" fill="url(#provenResultsGradientTop)" stroke="none" />
      </svg>
      ...
      <div className="relative max-w-6xl mx-auto mb-12 z-10 pt-4 overflow-hidden md:overflow-visible">
        <div className="mb-8 mt-0 md:-mt-8">
          <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground font-semibold block mb-2" style={{ fontFamily: 'var(--font-space-grotesk), sans-serif' }}>PROVEN RESULTS</span>
          <h2 id="proven-results-heading" className="sr-only">Proven Results</h2>
        </div>
              ...
              >
                ...
                <div className={`hidden md:flex shrink-0 items-center justify-center ${isLeftColumn ? 'order-1 md:-ml-32' : 'order-3 md:-mr-32'}`} style={{ overflow: 'visible' }}>
                  <div
                    ...
                    style={{
                      ...
                      whiteSpace: 'nowrap',
                      color: getCategoryColorHex(result.category)
                    }}
                  >
                    {caseNumber}
                  </div>
                ...
                <div className={`flex-1 ${isLeftColumn ? 'order-2' : 'order-2'} flex flex-col pr-2 md:pr-0`}>
                  <div className="mb-2 flex items-center gap-3">
                    ...
                    <span
                      className={`${result.color} px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider inline-block mb-2`}
                    >
                      {result.category}
                    </span>
                  </div>
                  ...
                  <div className="md:hidden">
                    <div
                      id={`proven-result-content-${index}`}
                    ...
                    <div className="flex justify-end pr-2">
                      <button
                        ...
                        aria-controls={`proven-result-content-${index}`}
      ...
      >
        <defs>
          <linearGradient id="provenResultsGradientBottom" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--color-brand-gradient-start)" />
            <stop offset="50%" stopColor="var(--color-brand-gradient-middle)" />
            <stop offset="100%" stopColor="var(--color-brand-gradient-end)" />
          </linearGradient>
        </defs>
        <path d="M0,40 Q300,20 600,40 T1200,40 L1200,60 L0,60 Z" fill="url(#provenResultsGradientBottom)" stroke="none" />
      </svg>
    </section>
  )
}
