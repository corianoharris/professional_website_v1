    ...
    <section id="services" className="px-8 md:px-16 py-12 md:py-16 relative" aria-labelledby="services-heading">
      ...
      <div className="max-w-6xl mx-auto relative z-10 pt-4">
        <div className="mb-12 -mt-8">
          ...
          <h2 id="services-heading" className="text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.9] tracking-tight mb-4">
            What I Deliver
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="relative p-8 rounded-2xl bg-card border-l-4 border-foreground shadow-lg hover:shadow-xl transition-shadow md:col-span-3">
            <span className="text-5xl font-bold text-muted-foreground/30 block mb-4">04</span>
            <p className="text-xl md:text-2xl leading-relaxed font-semibold text-foreground">
