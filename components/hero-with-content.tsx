...
export function HeroWithContent() {
  return (
    <section className="relative mt-7 overflow-x-hidden md:overflow-x-visible">
      ...
      <div className="relative px-2 md:px-6 -mt-[10vh] z-20 max-w-5xl mx-auto flex flex-col justify-center items-center -mb-32 overflow-x-hidden md:overflow-visible">
